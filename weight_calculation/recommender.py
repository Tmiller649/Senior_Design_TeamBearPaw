...
def extract_data(dataframe,keyword_filter,max_nutritional_values):
...
def recommand(dataframe,_input,max_nutritional_values,keyword_filter=None,params={'return_distance':False}):
...
if __name__ == "__main__":
    ...
    rec_data = recommand(master_df,test_input,max_list,keyword_filter=["vegan"])
