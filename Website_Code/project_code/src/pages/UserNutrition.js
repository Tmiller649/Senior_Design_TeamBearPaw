...
export default function UserNutrition() {
    ...
    return (
        <>{singleuser ? (
            ...
            <p><span className="currCount">20</span>/<span className="totCount">{singleuser.get_nutrition.FatContent[1]}</span>g</p>
            </div>
            <div className="ProgressBar">
            <label htmlFor="Carbs">Carbohydrates</label>
            <progress id="CarbProgress" value="255" name="Carbs" max={singleuser.get_nutrition.CarbohydrateContent[1]}></progress>
            <p><span className="currCount">255</span>/<span className="totCount">{singleuser.get_nutrition.CarbohydrateContent[1]}</span>g</p>
            </div>
            <div className="ProgressBar">
            ...
            <p><span className="currCount">100</span>/<span className="totCount">{singleuser.get_nutrition.SugarContent[1]}</span>g</p>
            </div>
            <div className="ProgressBar">
            <label htmlFor="Sodium">Sodium</label>
            <progress id="SodiumProgress" value="1200" name="Sugars" max={singleuser.get_nutrition.SodiumContent[1]}></progress>
            <p><span className="currCount">1200</span>/<span className="totCount">{singleuser.get_nutrition.SodiumContent[1]}</span>mg</p>
            </div>
            <div className="ProgressBar">
            <label htmlFor="Protein">Protein</label>
            <progress id="ProteinProgress" value="100" name="Sugars" max={singleuser.get_nutrition.ProteinContent[1]}></progress>
            <p><span className="currCount">100</span>/<span className="totCount">{singleuser.get_nutrition.ProteinContent[1]}</span>g</p>
            </div>
            </div>
        ):null}
        </>
